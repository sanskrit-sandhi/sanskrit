...
//        String slash_above = "\u0301";
        ...
        unicode.put("Î¶", "z"); //Urdu zal, ze, zoe
        unicode.put("Ï†", "f"); // Urdu f
        unicode.put("Î´",  "á¹›" ); // Hindi 'dh' as in padh
        unicode.put("Î”",  "á¹�" + "h"); // hindi dhh
        unicode.put("Ï„", "d"); // Urdu dwad
        unicode.put("Î¸", "t"); // Urdu toe
